...
public class MyBlockAdapter extends RecyclerView.Adapter<MyBlockAdapter.MyViewHolder> implements Filterable {
    ...
    public MyBlockAdapter(Context ctx, List<MyBlockResultDao> departList, String screenType) {
