...
public class MyBlockHistory extends BaseActivity {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                try {
                    ...
                    Intent intent = new Intent(MyBlockHistory.this, ResultDetails.class);
    ...
    private class TotalBlockResultAPI extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = ProgressUtil.showDialog(MyBlockHistory.this, getString(R.string.loading_message));
        }
