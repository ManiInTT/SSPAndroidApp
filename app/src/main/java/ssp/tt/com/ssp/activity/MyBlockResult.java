...
public class MyBlockResult extends BaseActivity {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                try {
                    ...
                    Intent intent = new Intent(MyBlockResult.this, ResultDetails.class);
    ...
    private void showMonthYear() {
        ...
        MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(MyBlockResult.this, new MonthPickerDialog.OnDateSetListener() {
            @Override
    ...
    private void getWidgetConfig() {
        ...
        toolbar.setTitle(getString(R.string.title_activity_my_black_result));
    ...
    private class TotalBlockResultAPI extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = ProgressUtil.showDialog(MyBlockResult.this, getString(R.string.loading_message));
        }
    ...
    private class MyCurrentBlockResultAPI extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                String userId = PreferenceConnector.readString(getApplicationContext(), PreferenceConnector.USER_ID, "");
                String imeiNumber = PreferenceConnector.readString(getApplicationContext(), PreferenceConnector.IMEI_NUMBER, "");
                serviceConnector.viewCurrentBlocks(getApplicationContext(), userId, imeiNumber);
            } catch (Exception e) {
            }
            return null;
        }
