...
public class ResultDetails extends BaseActivity {
    ...
    private void getWidgetConfig() {
        ...
        toolbar.setTitle(getString(R.string.title_activity_black_result_history));
    ...
    private class MyResultAPI extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = ProgressUtil.showDialog(ResultDetails.this, getString(R.string.loading_message));
        }
