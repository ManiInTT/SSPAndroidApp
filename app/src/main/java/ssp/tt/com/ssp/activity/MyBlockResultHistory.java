...
public class MyBlockResultHistory extends BaseActivity {
    ...
    private void setRecyclerView() {
        ...
        monthYear = simpleDateFormat.format(calendar.getTime());
        ...
        tvTotalEarningTitle.setText("Total block price for " +monthYear);
        ...
        recyclerView.addOnItemTouchListener(new RecyclerTouchListener(this,
            ...
            public void onClick(View view, final int position) {
                try {
                    ...
                    Intent intent = new Intent(MyBlockResultHistory.this, ResultDetails.class);
    ...
    private void getWidgetConfig() {
        ...
        toolbar.setTitle(getString(R.string.title_activity_my_black_result_history));
    ...
    private class TotalBlockResultAPI extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            dialog = ProgressUtil.showDialog(MyBlockResultHistory.this, getString(R.string.loading_message));
        }
    ...
    private class MyCurrentBlockResultAPI extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            try {
                String userId = PreferenceConnector.readString(getApplicationContext(), PreferenceConnector.USER_ID, "");
                String imeiNumber = PreferenceConnector.readString(getApplicationContext(), PreferenceConnector.IMEI_NUMBER, "");
                serviceConnector.viewPrevBlocks(getApplicationContext(), userId, imeiNumber,(month+1),year);
            } catch (Exception e) {
            }
            return null;
        }
    ...
    private void getCurrentResultResponse(String response) {
        ...
        try {
            ...
            if (status.equals("200")) {
                ...
                title = jsonObjectDesc.getString(webServiceUtil.title);
                errorMessage = jsonObjectDesc.getString(webServiceUtil.description);
                Util.warningAlertDialog(this, title, errorMessage, 1);

            }
        } catch (JSONException mException) {
            Log.i("JSONException", mException.getMessage());
            Util.warningAlertDialog(this, getResources().getString(R.string.warning), mException.toString(), 1);
        }
    }
